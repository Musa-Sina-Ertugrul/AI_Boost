...
class Layer(object):
    ...
    errorBias = property(_AIBoost.Layer_errorBias_get, _AIBoost.Layer_errorBias_set)
    bias = property(_AIBoost.Layer_bias_get, _AIBoost.Layer_bias_set)
    pastMomentumBias = property(_AIBoost.Layer_pastMomentumBias_get, _AIBoost.Layer_pastMomentumBias_set)
    pastVelocityBias = property(_AIBoost.Layer_pastVelocityBias_get, _AIBoost.Layer_pastVelocityBias_set)
